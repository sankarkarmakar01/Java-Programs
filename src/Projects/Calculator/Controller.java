...
import Projects.Calculator.SubClasses.Division;
import Projects.Calculator.SubClasses.*;

import java.util.*;

public class Controller {
    private final Scanner scanner = new Scanner(System.in);
    private final Map<String, CalculateOpeartions> operations;
    ...
    public void calculate(String choice) {
        ...
        try {
            ...
            CalculateOpeartions operation = operations.get(operator);
            if(operation == null) {
